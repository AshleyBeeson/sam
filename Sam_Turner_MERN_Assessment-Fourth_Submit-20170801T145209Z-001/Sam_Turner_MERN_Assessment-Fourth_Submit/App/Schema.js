...
var bugSchema = mongoose.Schema({
		...
		"reporter": String,
		"assignedUser": String,
		"actions": [{"user": String, "dateCreated":Date, "action": String}],
		"status": String
});
